package eu.atosresearch.conceptmanagement.activemq;
...
public class PublishCIM {
	...
	public static void publish(String topicName, String xml){
		...
		try {
			...
			env.setProperty(Context.INITIAL_CONTEXT_FACTORY,ConfigParameters.activemq_context);
			env.setProperty(Context.PROVIDER_URL, ConfigParameters.activemq_url);
